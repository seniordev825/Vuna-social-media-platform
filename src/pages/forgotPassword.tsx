...
const ForgotPassword: NextPage = () => {
  ...
  return (
    ...
    >
      <Head>
        <title>VUNA Updates | Forgot Password</title>
        <meta name="description" content="Reset your VUNA Updates password." />
      </Head>
      {/* Add Open Graph meta tags using Helmet */}
      <Helmet>
        <meta property="og:title" content="VUNA Updates | Forgot Password" />
        <meta
          property="og:description"
          content="Forgot your password? No worries! Reset your VUNA Updates password and get back to exploring the community."
        />
