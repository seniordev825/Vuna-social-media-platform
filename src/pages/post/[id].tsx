...
const Post: NextPage = () => {
  ...
  async function handleCreateAnswer({ content }: AnswerForm) {
    ...
    try {
      ...
      feedbackDescription = 'Your Comment has been successfully added!';
    }
  ...
  return (
    <Layout>
      <Head>
        <title>VUNA Updates| {Object.keys(post).length !== 0 && post.title}</title>
        <meta name="description" content={post.title || 'VUNA Updates Post'} />
      </Head>
              ...
              <Box>
                ...
                <Box as='section'>
                  <Heading
                    ...
                    maxW={'max-content'}
                  >
                    {totalAnswers} Comment{totalAnswers !== 1 && 's'}
                  </Heading>
                    ...
                    <Stack direction='column' spacing={8}>
                      {
                          ...
                          <PostInteractiveArea
                            ...
                            postId={postKey}
                              answerId={answer.id!} 
                              title={`Comment ${answer.index! < 10 && '0'}${answer.index!}`}
                ...
                >
                  ...
                  >
                    {() =>
                      <Form>
                        <FormControl>
                          <CustomTextarea name={'content'} placeholder={'What do you want to comment?'} />
                        </FormControl>
