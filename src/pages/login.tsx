...
const Login: NextPage = () => {
  ...
  return (
    ...
    >
      <Head>
        <title>VUNA Updates| Log In</title>
        <meta name="description" content="Log in to your VUNA Updates account and be part of our community." />
      </Head>
      <Helmet>
        <meta property="og:title" content="VUNA Updates | Login" />
        <meta
          property="og:description"
          content="Log in to your VUNA Updates account and be part of our community. Join discussions, share insights, and connect with a diverse community of like-minded individuals"
        />
